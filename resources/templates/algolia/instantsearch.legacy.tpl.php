            ...
            if(jQuery('#algolia-search-box').length > 0) {
                ...
                search.addWidget(
                    instantsearch.widgets.menu({
                        ...
                        limit: 10,
                        templates: {
                            header: '<h3 class="widgettitle">Art</h3>'
                        },
                    })
                );
                ...
                search.addWidget(
                    instantsearch.widgets.menu({
                        ...
                        sortBy: ['count'],
                        templates: {
                            header: '<h3 class="widgettitle"><?= __('Speakers', config('textdomain')) ?></h3>'
                        },
                        limit: 10,
                        showMore: true
                    })
                ...
                search.addWidget(
                    instantsearch.widgets.menu({
                        ...
                        sortBy: ['count'],
                        templates: {
                            header: '<h3 class="widgettitle"><?= __('Series', config('textdomain')) ?></h3>'
                        },
                        limit: 10,
                        showMore: true
                    })
                ...
                search.addWidget(
                    instantsearch.widgets.hierarchicalMenu({
                        ...
                        templates: {
                            header: '<h3 class="widgettitle"><?= __('Topics', config('textdomain')) ?></h3>'
                        }
                    })
                );
