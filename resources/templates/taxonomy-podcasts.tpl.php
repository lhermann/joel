...
>
     <channel>
            ...
            <googleplay:email>christopher.kramp@joelmedia.de</googleplay:email>
            ...
            <itunes:owner>
                    ...
                    <itunes:email>christopher.kramp@joelmedia.de</itunes:email>
            </itunes:owner>
            ...
            <?php if ( have_posts() ) :
                while ( have_posts() ) : the_post();
                    ...
                    $links = "<p><a href=\"$permalink\">Aufnahme ansehen</a>";
                    if ($yt_url) {
                        $links .= "<br><a href=\"$yt_url\">Video auf YouTube</a>";
                    }
                    $links .= "</p>";
