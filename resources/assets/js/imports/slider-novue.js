...
function Slide(id, slide, nav, slideTransition) {
    ...
    this.slideTransition =
        typeof slideTransition === "number" ? slideTransition : 800;
    this.isTeaser = $(slide).children(".c-slide--teaser").length > 0;
...
function Slider(slider, slideDelay, slideTransition) {
    ...
    slides.reverse().unshift(slides.pop());
