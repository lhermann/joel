...
function register_answer_post_type () {
  register_post_type('answer', [
    ...
    'labels' => [
      'name' => _x('Answers', 'post type general name', config('textdomain')),
      'singular_name' => _x('Answer', 'post type singular name', config('textdomain')),
      'menu_name' => _x('Answers', 'admin menu', config('textdomain')),
      'name_admin_bar' => _x('Answers', 'add new on admin bar', config('textdomain')),
